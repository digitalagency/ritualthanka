            ...
            <div class="box box-success">
                ...
                <div class="box-body" id="option-list">
                    ...
                    if($options!=""){
                        ...
                        <div class="hr<?php echo $optionCount?> hrborder">
                        <hr>
                        </div>
                        <?php
                        $optionCount++;
                                        ...
                                        @foreach ($articles as $article)
                                            @if($related_article !="")
                                                @if(in_array($article->id,$related_article))
                                                    <li><label><input type="checkbox" checked name="related_article[]" value="{!! $article->id !!}"></label> {!! $article->title !!}</li>
                                                @else
                                                    <li><label><input type="checkbox" name="related_article[]" value="{!! $article->id !!}"></label> {!! $article->title !!}</li>
                                                @endif
                                            @else
                                                <li><label><input type="checkbox" name="related_article[]" value="{!! $article->id !!}"></label> {!! $article->title !!}</li>
                                            @endif
