...
@section('content')
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.page.edit') }}</h3>
        ...
        <div class="box-body">
                ...
                <div class="col-lg-10">
                    ...
                    <span class="input-group-btn">
                     <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary">
                        ...
                        {{ Form::text('image', null, ['class' => 'form-control', 'id'=>'thumbnail', 'placeholder' => trans('validation.attributes.backend.access.page.description')]) }}
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <div class="radio">
                        <label>
                            <input type="radio" name="status" id="status" value="1" <?php echo ($pageInfo->status==1) ? 'checked="checked"' : ''; ?>>
                            Publish
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="status" id="status" value="0" <?php echo ($pageInfo->status==0) ? 'checked="checked"' : ''; ?>>
                            Unpublish
                        </label>
                    </div>
                </div><!--col-lg-1-->
